    ...
    <div className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <div className="flex items-center justify-between mb-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-3xl font-black text-on-surface tracking-tighter uppercase mb-1">Danh mục Tin tức</h2>
            <p className="text-sm text-on-surface-variant/60 font-medium italic">Quản lý các phân loại bài viết tin tức.</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          {loading ? (
            ...
            <div className="bg-white rounded-[2rem] p-20 border border-dashed border-on-surface/20 flex flex-col items-center text-center">
              <Tag size={48} className="text-on-surface-variant/20 mb-4" />
        ...
        <div className="lg:col-span-1">
          ...
          {!isAdding && (
            <div className="bg-slate-50 rounded-[2.5rem] p-10 border border-dashed border-on-surface/10 flex flex-col items-center text-center sticky top-28">
              ...
              <p className="text-xs font-bold text-on-surface mb-2 uppercase tracking-tight text-center">Sẵn sàng thêm mới?</p>
              <p className="text-[10px] text-on-surface-variant/60 font-medium italic mb-6 text-center">Nhấn nút bên dưới hoặc phía trên để bắt đầu thêm phân loại mới cho bài viết của bạn.</p>
              <button
