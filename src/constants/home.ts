export const HERO_SLIDES = [
  {
    id: 1,
    tag: "Đại lý Khai báo Hải quan Uy tín tại Quảng Trị",
    title: "VILA <br /> <span class='text-transparent bg-clip-text bg-gradient-to-r from-primary via-emerald-400 to-primary'>SANMYSHI</span> <br /> LOGISTICS",
  ...
  {
    id: 2,
    tag: "Chuyên gia Hành lang Kinh tế Đông - Tây",
    title: "KẾT NỐI <br /> <span class='text-transparent bg-clip-text bg-gradient-to-r from-primary via-emerald-400 to-primary'>LỤC ĐỊA</span> <br /> XUYÊN BIÊN GIỚI",
  ...
  {
    id: 3,
    tag: "Hệ thống Kho bãi đạt chuẩn Quốc tế",
    title: "DỊCH VỤ <br /> <span class='text-transparent bg-clip-text bg-gradient-to-r from-primary via-emerald-400 to-primary'>KHO VẬN</span> <br /> HIỆN ĐẠI",
