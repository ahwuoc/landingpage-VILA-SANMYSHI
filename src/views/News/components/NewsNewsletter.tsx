...
export default function NewsNewsletter() {
  ...
  return (
    <section className="py-12 md:py-24 bg-primary text-on-primary mx-4 md:mx-8 my-10 md:my-20 rounded-[2rem] md:rounded-[4rem] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-white/10 rounded-full blur-[60px] md:blur-[100px] -translate-y-1/2" />
